...
const credentials = {
  ...
  redirect_uris: ["https://drixaboi.github.io/DrixMeets/"],
  javascript_origins: ["https://drixaboi.github.io", "https://localhost:3000"],
};
...
module.exports.getAccessToken = async (event) => {
  ...
  const code = decodeURICommponent(`${event.pathParameters.code}`);
